    ...
    onLoad(options) {
        ...
        app.Util.network.GET({
            ...
            success: data => {
                ...
                if (product.categories.some(c => c.id === 34)) {
                    this.setData({productNotice: `
                    销售说明 
                    1. 由于家具是手工打造，所以需要5-8周的手工制作时间，请耐心等候。您可以进入“啄一”服务号点击在线客服，咨询您的家具制作情况。
                    2. 家具为整装，整体运输，无需组装。因该家具尺寸较大，且衣帽杆较长，请在购买前确认能否上楼入户。
                    3. 中国大陆地区（非港澳台）包邮，家具将免费配送入户，七楼以上无电梯用户除外，请在下单后提前联系“啄一”服务号在线客服。
                    ...
                    `});
                } else if (product.categories.some(c => c.id === 15)) {
                    this.setData({productNotice: `
                    售后声明
                    啄一支持7天内退换货，请您于签收后7个工作日内，在保证商品无损的情况下联系“啄一”微信服务号在线客服办理退换货。由于商品质量问题产生的退换货，运费由啄一承担，若为非质量问题，则运费由用户承担。
                    `});
                }
